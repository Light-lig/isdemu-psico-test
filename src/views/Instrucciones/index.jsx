...
<h2 className="text-2xl font-bold mb-4">INSTRUCCIONES PARA EL DESARROLLO DE LA AUTOEVALUACION</h2>
<ol className="list-decimal pl-4 mb-8">
  ...
  <li className="mb-2">Hay una escala de calificación que es la siguiente:</li>
</ol>
...
<table className="w-full border-collapse border border-gray-300">
  ...
  <tbody>
    <tr>
      ...
      <td className="border border-gray-300 px-4 py-2">TOTALMENTE DE ACUERDO</td>
      <td className="border border-gray-300 px-4 py-2">5</td>
      <td className="border border-gray-300 px-4 py-2">MUY FRECUENTEMENTE</td>
      <td className="border border-gray-300 px-4 py-2">5</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td className="border border-gray-300 px-4 py-2">TOTALMENTE EN DESACUERDO</td>
      <td className="border border-gray-300 px-4 py-2">1</td>
...
<ol className="list-decimal pl-4 mt-8">
  <li className="mb-2">Se te dará una nota individual al final de cada instrumento de autoevaluación gerencial</li>
  <li className="mb-2">Al finalizar las 5 herramientas de autoevaluación gerencial, se te dará una nota promedio de las 5 herramientas</li>
  <li className="mb-2">En cada instrumento, el puntaje máximo que se puede llegar a alcanzar es 100 puntos</li>
  <li className="mb-2">Por ende, los puntos totales, juntando los 5 instrumentos son 500 puntos</li>
  <li className="mb-2">Cada instrumento cuenta con un total de 20 preguntas, y por todos los instrumentos un total de 100 preguntas</li>
</ol>
</div>
