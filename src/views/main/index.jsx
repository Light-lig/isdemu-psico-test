export const Main = () => (
    ...
    <p className="mb-8">
      El Instituto Salvadoreño para el Desarrollo de la Mujer, se creó a iniciativa del Órgano Ejecutivo por Decreto Legislativo No. 644, de fecha 29 de febrero de 1996.
    </p>
  
    <h2 className="text-2xl font-bold mb-4">Nuestra Misión como ISDEMU</h2>
    <p className="mb-8">
      Promover que la igualdad entre mujeres sea una política del Estado Salvadoreño.
    </p>
  
    <h2 className="text-2xl font-bold mb-4">Nuestra Visión como ISDEMU</h2>
    <p>
      Que las mujeres ejerzan sus derechos con la garantía y protección del Estado.
    </p>
  </div>
